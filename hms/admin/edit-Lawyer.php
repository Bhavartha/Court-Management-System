...
if($sql)
{
$msg="Lawyer Details updated Successfully";
...
<html lang="en">
	<head>
		<title>Admin | Edit Lawyer Details</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Edit Lawyer Details</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Edit Lawyer info</h5>
												</div>
