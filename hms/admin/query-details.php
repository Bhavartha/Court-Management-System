...
$oldmsg = $row['message'];
$courtquery = $row['AdminRemark'];
$PostingDate = $row['PostingDate'];
$lastupddate = $row['LastupdationDate'];


         $to = "$email";
         $subject = "COURT QUERY REPLAY";
         
         $message = "<h1>WELCOME TO CMS.</h1><br>";
         $message .= "<b>Name</b> = $fullname <br>";
		 $message .= "<b>Contact Number</b> = $contactno<br><br>";
		 
         $message .= "<b>Your Entered Query</b> = $oldmsg";
		 $message .= " <br>This query was entered on $PostingDate from your side.<br><br>";
		 $message .= "<b>Court Query</b> = $courtquery <br>";
		 $message .= "we checked your query today $lastupddate and we send remark on that as follow.";
