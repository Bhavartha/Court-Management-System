...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Lawyer | Add Clients</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Lawyer</span>
...
<textarea type="text" name="medhis" class="form-control"  placeholder="Enter Case History(if any)" required="true"><?php  echo $row['PatientMedhis'];?></textarea>
</div>	
<div class="form-group">
<label for="fess">
 Creation Date
